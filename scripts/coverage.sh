...
TEST_DATABASE_URL=$PG_URL go test ./postgres/... -tags=integration -coverprofile integration.coverage.txt -coverpkg=github.com/khostya/effective-mobile/internal/repo/postgres
