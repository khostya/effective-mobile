...
import (
	...
	transactor "github.com/khostya/effective-mobile/internal/repo/transactor"
...
func (m *MockQueryEngine) Query(ctx context.Context, sql string, arguments ...any) (pgx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, sql}
	for _, a := range arguments {
		varargs = append(varargs, a)
...
func (mr *MockQueryEngineMockRecorder) Query(ctx, sql any, arguments ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, sql}, arguments...)
